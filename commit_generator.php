...
$baseInstruction = "Отвечай всегда на русском. Название коммита должна быть до 50 символов и начинаться с глагола в прошедшем времени (например, Реализовал, Улучшил, Создал). Описание коммита в виде списка с тире. После названия комита оставлять пустую сроку, далее описание. Форматируй текст коммита так, чтобы длина каждой строки не превышала 50 символов (в описании пустые строки делать не нужно) и без точек в конце. При необходимости переносите слова на новую строку согласно правилам переноса в русском языке.";
